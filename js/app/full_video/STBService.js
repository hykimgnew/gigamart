...
/**
 *  Full_video Js : STBService (셋탑박스 서비스 공통)
 **/
App.defineClass('Gigamart.app.full_video.STBService', { 
	...
	_construct: function () {
		...
		me.keyEventProvider = Gigamart.app.full_video.KeyEventActorProvider.create();
