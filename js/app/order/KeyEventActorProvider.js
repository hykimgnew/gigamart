...
function deleteCart() 
{
    ...
    // 삭제하기
        ...
        for(var i=0 ; i < arrChkProductId.length ; i++) {
            ...
            console.log("i : " + i + "  arrChkProductId-1 : " + (arrChkProductId.length-1));
            $.ajax({
...
function orderPayment() {
    ...
    var param = {
                    ...
                    "delivery_cost" : 0,
                    "shopper_cost" : 2000,
                    "ordered_cost" : Number($('#order_total_cost').html().replace(/^[-]|[^0-9-]/gi,"")),
                    "shopper_msg" : "",
                    "receiver_name" : "",
                    "receiver_tel" : "",
                    "receiver_phone" : "",
                ...
                if (keyCode === global.VK_ENTER) {
                    ...
                    if(orderCartProductYN) {
                        ...
                        // <주문내역조회>
                            ...
                            location.href = "mypage.html?SHOPPER_STATUS" + SHOPPER_STATUS+ '&userID='+ userID + '&userName=' + userName;
                        }
                        // <메뉴 돌아가기>
